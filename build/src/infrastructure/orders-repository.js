...
const getOrdersByUserId = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        const getOrds = Promise.all(user.orders.map((order) => __awaiter(void 0, void 0, void 0, function* () {
            return yield client_1.default.order.findUnique({
                where: { id: order.id },
                include: { productInOrder: true },
            });
        })));
        const orders = Promise.all((yield getOrds).map((order) => __awaiter(void 0, void 0, void 0, function* () {
            const preProds = yield client_1.default.productInOrder.findMany({
                where: { orderId: order.id },
                include: { product: true },
            });
            const prods = preProds.map((prod) => {
                return {
...
const postOrder = (data, arr, total) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    arr.forEach((e) => __awaiter(void 0, void 0, void 0, function* () {
