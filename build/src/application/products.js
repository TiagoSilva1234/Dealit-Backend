...
exports.patchProduct = exports.getProductsStatsByUserId = exports.getProductsByUserId = exports.getAllProductsPaginated = exports.getProductsByCategory = exports.postNewProduct = exports.getProductById = void 0;
...
const get_soldProdStats_1 = __importDefault(require("../domain/products/get-soldProdStats"));
...
const getProductsStatsByUserId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.params.userId;
        if (isNaN(Number(userId))) {
            return res.status(http_status_codes_1.StatusCodes.BAD_REQUEST).send({
        ...
        return res.send(yield (0, get_soldProdStats_1.default)(Number(userId)));
    }
    catch (e) {
        if (e.message === "User does not exist") {
            return res.status(http_status_codes_1.StatusCodes.NOT_FOUND).send({
...
exports.getProductsStatsByUserId = getProductsStatsByUserId;
