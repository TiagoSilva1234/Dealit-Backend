...
const postReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.body.userId, productId = req.body.productId, comment = req.body.comment, photo = req.body.photo, rating = req.body.rating, reviewer = req.body.reviewer;
        ...
        if (userId !== undefined) {
            ...
            const resRev = yield (0, post_review_1.default)(data);
