const { getProductById, postNewProduct,getProductsByCategory,getAllProductsPaginated,getProductsByUserId } = require("../Products");
...
describe("Products Endpoints", () => {
  ...
  describe("get product by category", () => {
    ...
    it("should return unexpected error",async ()=>{
      ...
      await getProductsByCategory({params: {category: "Clothing"},query:{}}, mockSend);
    ...
    describe("get products paginated", () => {
      ...
      it("should return unexpected error",async ()=>{
        ...
        await getAllProductsPaginated({params: {category: "Clothing"},query:{}}, mockSend);
    ...
    describe("get products by user Id", () => {
      ...
      it("should return invalid id format",async ()=>{  
        await getProductsByUserId({params: {userId:"asd"},query:{}}, mockSend);
      ...
      it("should return all prods with that user id",async ()=>{
        ...
        await getProductsByUserId({params: {userId:"1"},query:{}}, mockSend);
